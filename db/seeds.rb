...
Plant.create!(
  name: "Ganja",
  image_url: "https://i2-prod.mirror.co.uk/incoming/article7707482.ece/ALTERNATES/s615/PAY-MAIN-Police-officers-find-the-drugs-factory.jpg",
  garden: other
)
...
names = %w( fruta cacto planta flor)
